...
N 160 -110 330 -110 {lab=VDD}
N 280 -290 280 -110 {lab=VDD}
...
N -420 170 160 170 {lab=VDD}
N -420 170 -160 -370 {lab=VDD}
C {PMOS_MIN.sym} -70 -290 0 1 {name=M1 model=pch w=20u l=1u as=0 ps=0 ad=0 pd=0 m=1}
C {PMOS_MIN.sym} 200 -290 0 0 {name=M2 model=pch w=20u l=1u as=0 ps=0 ad=0 pd=0 m=1}
...
C {iopin.sym} -180 -370 2 0 {name=p5 lab=VDD}
