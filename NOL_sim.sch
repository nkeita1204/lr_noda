...
N 170 0 260 0 {lab=#net1}
N -100 -270 -100 -240 {lab=#net2}
N -100 -270 -0 -270 {lab=#net2}
N -0 -270 0 -70 {lab=#net2}
N -100 -180 -100 -140 {lab=GND}
N 260 0 370 0 {lab=#net1}
N 40 -140 410 40 {lab=GND}
N 0 -270 410 -40 {lab=#net2}
N 480 0 540 -0 {lab=CLK2}
C {NOL.sym} 20 -10 0 0 {name=x1}
...
C {code_shown.sym} 70 -530 0 0 {name=s4 only_toplevel=false value="
.include C:/Users/ISLab2/Documents/minimal_LR/OSU035.txt"}
